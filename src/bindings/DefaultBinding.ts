...
// Copy VSCode's default keybindings here
export const DefaultBinding: IKeyBinding[] = [
	...
	{ "key": "ctrl+alt+c",            "command": "extension.convertSelection",
										"when": "editorTextFocus" },
	{ "key": "ctrl+l g",              "command": "extension.openInGitHub" },
	{ "key": "ctrl+alt+r",            "command": "extension.snippetSearch",
										"when": "editorTextFocus" },
	{ "key": "ctrl+alt+8",            "command": "extension.swapSelections",
										"when": "editorTextFocus" },
	...
	{ "key": "ctrl+alt+0",            "command": "insertSequentialNumbers",
										"when": "editorTextFocus" },
	{ "key": "ctrl+shift+alt+v",      "command": "jsonToTs.fromClipboard" },
	{ "key": "ctrl+n",                "command": "luna.file.new",
	...
	{ "key": "f9",                    "command": "sortLines.sortLines",
										"when": "editorTextFocus" },
	{ "key": "ctrl+t f",              "command": "textPowerTools.filterLinesIncludingString",
										"when": "editorTextFocus" },
	...
	{ "key": "ctrl+shift+alt+s",      "command": "jsonToTs.fromSelection" },
	{ "key": "ctrl+shift+'",          "command": "luna.file.newDefaultSize" },
	...
	{ "key": "ctrl+shift+alt+v",      "command": "quicktype.pasteJSONAsTypes",
										"when": "editorTextFocus" },
	{ "key": "ctrl+t g",              "command": "textPowerTools.generateRandomGuids",
										"when": "editorTextFocus" },
	...
	{ "key": "ctrl+'",                "command": "luna.file.importFromClipboard" },
	...
	{ "key": "ctrl+shift+i",          "command": "luna.adjustments.invert",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+c",                "command": "luna.edit.copy",
										"when": "luna:focused && !luna:textFocused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+x",                "command": "luna.edit.cut",
										"when": "luna:focused && !luna:textFocused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "alt+,",                 "command": "gitlens.key.alt+,",
										"when": "gitlens:key:," },
	{ "key": "ctrl+v",                "command": "luna.edit.paste",
										"when": "luna:focused && !luna:textFocused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "alt+.",                 "command": "gitlens.key.alt+.",
										"when": "gitlens:key:." },
	{ "key": "ctrl+shift+x",          "command": "luna.image.cropToSelection",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+r",                "command": "luna.image.resize",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+shift+r",          "command": "luna.image.canvasSize",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+j",                "command": "luna.image.rotate180",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+h",                "command": "luna.image.rotate90Clockwise",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+g",                "command": "luna.image.rotate90CounterClockwise",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+shift+f",          "command": "luna.image.flattenLayers",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "enter",                 "command": "luna.image.finishActiveAction",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "alt+h",                 "command": "gitlens.showQuickFileHistory",
										"when": "!gitlens:disabled && config.gitlens.keymap == 'alternate'" },
	{ "key": "ctrl+shift+n",          "command": "luna.layer.addNewLayer",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+shift+g h",        "command": "gitlens.showQuickFileHistory",
										"when": "!gitlens:disabled && config.gitlens.keymap == 'chorded'" },
	{ "key": "ctrl+shift+delete",     "command": "luna.layer.deleteLayer",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "shift+alt+h",           "command": "gitlens.showQuickRepoHistory",
										"when": "!gitlens:disabled && config.gitlens.keymap == 'alternate'" },
	{ "key": "ctrl+m",                "command": "luna.layer.mergeLayerDown",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+alt+pagedown",     "command": "luna.layer.goToBottomLayer",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "k",                     "command": "luna.tool.colorPicker",
	...
	{ "key": "p",                     "command": "luna.tool.pencil",
										"when": "luna:focused && !sideBarFocus && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "s",                     "command": "luna.tool.selection",
										"when": "luna:focused && !sideBarFocus && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "o",                     "command": "luna.tool.toggleShapeTool",
										"when": "luna:focused && !sideBarFocus && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "m",                     "command": "luna.tool.toggleMoveTool",
										"when": "luna:focused && !sideBarFocus && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "x",                     "command": "luna.palette.swapColors",
										"when": "luna:focused && !sideBarFocus && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+d",                "command": "luna.selection.deselect",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "delete",                "command": "luna.selection.erase",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+a",                "command": "luna.selection.selectAll",
										"when": "luna:focused && !luna:textFocused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "escape",                "command": "luna.view.focusCanvas",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	...
	{ "key": "ctrl+unknown",          "command": "luna.view.zoomIn",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	{ "key": "ctrl+shift+g shift+,",  "command": "gitlens.diffLineWithPrevious",
										"when": "editorTextFocus && config.gitlens.keymap == 'chorded' && gitlens:activeFileStatus =~ /tracked/" },
	{ "key": "ctrl+-",                "command": "luna.view.zoomOut",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
	{ "key": "ctrl+9",                "command": "luna.view.actualSize",
										"when": "luna:focused && activeCustomEditorId == 'luna.editor' && focusedView == ''" },
